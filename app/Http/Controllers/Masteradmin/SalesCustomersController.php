...
class SalesCustomersController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        SalesCustomers::create([
            ...
            // 'sale_cus_fax' => $validatedData['sale_cus_fax'],
            // 'sale_cus_mobile' => $validatedData['sale_cus_mobile'],
            // 'sale_cus_toll_free' => $validatedData['sale_cus_toll_free'],
            ...
            // 'sale_ship_currency_id' => $validatedData['sale_ship_currency_id'],
