                ...
                <div class="row justify-content-end">
                  <div class="col-md-7 float-sm-right px-10">
                    <input type="text" class="form-control text-right" name="sale_estim_summary" id="invoicesummary"
                      placeholder="Summary (e.g. project name, description of estimate)" value="{{ $invoices->sale_inv_summary }}">
                  </div>
                </div>
                <div class="px-10">
        ...
        <div class="row justify-content-between">
          <div class="col-md-12">
            <textarea id="inputDescription" name="sale_estim_footer_note" class="form-control" rows="3"
              placeholder="Enter a footer for this estimate (e.g. tax information, thank you note)">{{ $invoices->sale_inv_footer_note }}</textarea>
          </div>
        </div>
        <!-- /.row -->
      </div>
