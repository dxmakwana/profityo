...
@section('content')
      ...
      <div class="container-fluid">
            ...
            <div class="row justify-content-between">
              <div class="col-md-3 px-10">
                ...
                @if($businessDetails && $businessDetails->bus_image)
                  <img src="{{ url(env('IMAGE_URL').'masteradmin/business_profile/' . $businessDetails->bus_image) }}" class="elevation-2" target="_blank">
                  <!-- <h3 class="card-title float-sm-right px-10" data-toggle="modal" data-target="#removebusinessimage">Remove image</h3> -->
                  
                  <div class="modal fade" id="removebusinessimage" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                    <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                      <div class="modal-content">
                        <div class="modal-body pad-1 text-center">
                          <i class="fas fa-solid fa-trash delete_icon"></i>
                          <p class="company_details_text">Removing your logo will remove it from all existing and future invoices and estimates. Are you sure you want to remove your business logo?</p>
                ...
                @method('patch')
                  ...
                  <p class="upload_text">Browse or Drop your Logo Here Maximum 5MB in Size. JPG, PNG, or GIF Formats. Recommended Size: 300 x 200 Pixels.</p>
                </form>
                @endif
              ...
              <div class="col-md-7 px-10">
                ...
                <div class="row justify-content-end">
                  <div class="col-md-7 float-sm-right px-10">
                    <input type="text" class="form-control text-right" id="estimatesummary" placeholder="Summary (e.g. project name, description of estimate)">
                  </div>
                </div>
                <div class="px-10">
                  ...
                  <p class="company_details_text text-right">{{ $businessDetails->state->name ?? '' }}, {{  $businessDetails->city_name }} {{ $businessDetails->zipcode }}</p>
                ...
                <h3 class="card-title float-sm-right px-10" data-toggle="modal" data-target="#editbusiness_companyaddress"><img src="{{url('public/dist/img/dot.png')}}" class="dot_img">Edit your business address and contact details</h3>
              </div>
              <!-- /.col -->
            </div>
            <!-- /.row -->
          ...
          <div class="card-body2">
                  ...
                  <div class="col-md-3">
                    <div class="form-group">
                      ...
                      <div class="input-group date" id="estimatevaliddate" data-target-input="nearest">
                        <input type="text" class="form-control datetimepicker-input" placeholder="" data-target="#estimatevaliddate"/>
            ...
            <div class="row px-10">
              <div class="col-md-12 text-right">
                <button class="editcolum_btn" data-toggle="modal" data-target="#editcolum"><i class="fas fa-solid fa-pen-to-square mr-2"></i>Edit Columns</button>
            ...
            <div class="row pad-2">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <textarea id="inputDescription" class="form-control" rows="3" placeholder="Enter notes or terms of service that are visible to your customer"></textarea>
                </div>
              </div>
            </div>
            <!-- /.row -->
        ...
        <div class="card card-default">
          ...
          <div class="card-body">
            <div class="row justify-content-between">
              <div class="col-md-12">
                <textarea id="inputDescription" class="form-control" rows="3" placeholder="Enter a footer for this estimate (e.g. tax information, thank you note)"></textarea>
              </div>
            </div>
            <!-- /.row -->
          </div>
  ...
  <!-- /.control-sidebar -->
  <div class="modal fade" id="editbusiness_companyaddress" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <div class="row pxy-15 px-10">
              <div class="col-md-12">
                <div class="form-group">
                  <x-input-label for="company-business" :value="__('Company/Business')" > <span class="text-danger">*</span></x-input-label>
...
$(document).ready(function() {
  ...
  $('.add_customer_box').on('click', function() {
        ...
        if ($customerList.is(':visible')) {
            // If the list is already visible, hide both the list and the box
            $customerList.hide();
            $addCustomerBox.show(); // Show the add_customer_box again
        } else {
            // Hide the add_customer_box and show the list
            $('.add_customer_list').hide(); // Hide any other lists if they are visible
            $('.add_customer_box').show(); // Ensure add_customer_box is visible
            $customerList.show(); // Show the clicked list
            $addCustomerBox.hide(); // Hide the add_customer_box
        }
    });
});
</script>
